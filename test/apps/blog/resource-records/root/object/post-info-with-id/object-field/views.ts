...
export const postInfoWithIdObjectViewsObjectFieldResourceRecord: ResourceRecord<ObjectFieldSpecificResourceSettings> =
  {
    id: `${POST_INFO_WITH_ID_OBJECT_RESOURCE_ID}-views-object-field`,
