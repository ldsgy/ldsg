...
export const postInfoWithoutIdObjectContentObjectFieldResourceRecord: ResourceRecord<ObjectFieldSpecificResourceSettings> =
  {
    id: `${POST_INFO_WITHOUT_ID_OBJECT_RESOURCE_ID}-content-object-field`,
